...
WB = 1.417674418604651 # rear to front wheel
W = 1.6764  # width of car
LF = 1.559441860465116 # distance from rear to vehicle front end
LB = 0.4725581395348838  # distance from rear to vehicle back end
...
def move(x, y, yaw, distance, steer, L=WB):
    ...
    # Calculate angular velocity (rate of change of orientation)
    angular_velocity = distance * tan(steer) / L

    # Calculate speed for left and right wheels
    speed_left_wheel = (linear_velocity - (angular_velocity * L / 2))
    speed_right_wheel = (linear_velocity + (angular_velocity * L / 2))
    wheel_speeds.append((speed_left_wheel, speed_right_wheel))
    return x, y, yaw
